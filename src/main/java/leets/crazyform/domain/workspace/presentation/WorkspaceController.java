...
import leets.crazyform.domain.workspace.usecase.Workspace;
...
public class WorkspaceController {
    ...
    public WorkspaceResponse updateWorkspace(@PathVariable UUID workspaceId, @Validated @RequestBody WorkspaceRequest workspaceRequest) {
        ...
        return new WorkspaceResponse(workspace.getId(), workspace.getName(), workspace.getHandle(), workspace.getCreatedAt
